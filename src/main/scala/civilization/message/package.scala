...
package object message {
  ...
  object M extends Enumeration {
    ...
    RESOURCEAVAILIBILITYCANBEUSERONCEPERTURN, CANNOTDEVOUTTHICCITYFORCULTURE, NOTENOUGHRESOURCETOUSETECHNOLOGY,
    ...
    NOTPLAYERTURNTOENDOFPHASE, TECHNOLOGYUSEDALREADYINTHISTURN, COINSCAPACITYEXCEEDED = Value
  }
