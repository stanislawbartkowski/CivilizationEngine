...
package object message {
  ...
  object M extends Enumeration {
    ...
    CANNOTSETFIGUREONHUTORVILLAGE, NOTENOUGHTRADETOSPENDFORPROD, NOSCOUTATTHISPOINT,CANNOTSENTPRODTWICESCOUT, SCOUTISONCITYOUTSKIRT,
    ALLUNITSUSED, COMMANDPARAMETERDOESNOTMATCH = Value
  }
