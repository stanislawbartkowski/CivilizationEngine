...
package object message {
  ...
  object M extends Enumeration {
    ...
    CANNOTBUYBUILDINGHERE, CANNOTBUYWONDERGHERE, CANNOTENDOFRESEARCHTWICEORNOTREASEARCH,INVALIDTECHNOLOGYACTION,
    RESOURCEAVAILIBILITYCANBEUSERONCEPERTURN,CANNOTENDOFTRADETWICE, CANNOTDEVOUTTHICCITYFORCULTURE,
    ...
    YOUCANNOTSPENDSECONDSILKONYOUSELF= Value
  }
