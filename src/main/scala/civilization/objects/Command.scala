...
object Command extends Enumeration {
  ...
  DROPCULTURECARD, DROPCOINFROMTECHNOLOGY, GETCOIN, GETTECHNOLOGY, CITYLOST, PLAYERWIN, ENDOFGAME = Value
  ...
  def cityActionUnique(t: Value): Boolean = (t == BUYARMY || t == BUYSCOUT || t == BUYARTILLERY ||
    t == BUYAIRCRAFT || t == BUYINFANTRY || t == BUYMOUNTED || t == HARVESTRESOURCE || t == BUYBUILDING || t == BUYWONDER || t == POTTERYACTION || t == PHILOSOPHYACTION || t == DEVOUTTOCULTURE || t == CURRENCYACTION || t == BUYCITYWALL || t == FREEBUILDINGCITYACTION || t == METALCASTINGACTION || t == BANKINGACTION || t == CHIVALRYACTION)
