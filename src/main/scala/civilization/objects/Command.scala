...
object Command extends Enumeration {
  ...
  SACRIFICEFIGUREFORTECH, RESEARCHFREETECHNOLOGY, FREENONUPGRADEDBUILDING,TAKEFREEALLRESOURCESFROMMARKET,USESILKFORTRADE9, INCREASETRADE = Value
  ...
  def internalAction(t: Value): Boolean = t == Command.ADVANCECULTUREFORFREE || t == FORCEDMOVEFIGURES || t == TAKEUNIT ||
    t == BUILDCITYWALLFORFREE || t == ADVANCECULTUREFORFREE || t == GET3CULTURE || t == RANDOMWONDER || t == GETCULTURE || t == RESEARCHFREETECHNOLOGY || t == TAKEFREEALLRESOURCESFROMMARKET || t == INCREASETRADE
